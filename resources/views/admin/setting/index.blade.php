          ...
          <form class="forms-sample" method="POST" action="{{ route('admin.setting.update', $setting->id ) }}"
            ...
            <div class="row">
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" id="exampleInputName1" name="about_title" placeholder="Title"
                  value="{{ $setting->about_title }}" required>
              </div>
            </div>
            <div class="form-group">
              <label for="exampleTextarea1">Description</label>
              <textarea class="form-control" id="exampleTextarea1" rows="4" maxlength="255" name="about_description"
                required>{{ $setting->about_description }}</textarea>
            </div>
            <div class="form-group">
    ...
    {{-- <div class="col-12">
      <div class="card mt-3">
        <div class="card-body">
          ...
          <h4 class="card-title">Favicon Settings</h4>
          <p class="card-description">Upload website favicon icon</p>
          ...
          <form method="POST" action="{{ route('admin.setting.update', $setting->id) }}" enctype="multipart/form-data">
            ...
            @if($setting->favicon)
            <img src="{{ asset('storage/' . $setting->favicon) }}" width="40">
            @endif
